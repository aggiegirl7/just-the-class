...
1. Create a [new repository based on Just the Class](https://github.com/

lin1/just-the-class/generate).
...
lin1/just-the-class/discussions/categories/show-and-tell)!
